...
public class BindingThingTypesFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(me.willowcheng.makerthings.R.layout.bindingthingtypeslist_fragment, container, false);
        mSwipeLayout = (SwipeRefreshLayout) view.findViewById(me.willowcheng.makerthings.R.id.swipe_container);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mActivity.setTitle(me.willowcheng.makerthings.R.string.app_bindings_supportedthings);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        bindingThingTypesAdapter = new BindingThingTypesAdapter(this.getActivity(), me.willowcheng.makerthings.R.layout.bindingthingtypeslist_item, thingTypes);
